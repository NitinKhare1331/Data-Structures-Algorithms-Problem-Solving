var Node = function(data){
    this.data = data;
    this.next = null; //untill or unless we attach this new node to a list,the next property should be null
} 


var MyLinkedList = function() {
    this.head = null; // because initially everthing is empty
};
...
MyLinkedList.prototype.addAtHead = function(val) {
    if(this.head == null){
        //means ll is empy so this node should become head
...
MyLinkedList.prototype.addAtTail = function(val) {
    if(this.head == null){
        ...
        //when the loop ends, temp points the tail node
        let n = new Node(val);
        temp.next = n;
    }
};
